...
import static demo.hankcs.book.ch03.DemoNgramSegment.*;
import static demo.hankcs.hanlp.seg.common.CWSEvaluator.evaluate;
...
public class EvaluateBigram
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        CWSEvaluator.Result result = CWSEvaluator.evaluate(segment, MSR.TEST_PATH, MSR.OUTPUT_PATH, MSR.GOLD_PATH, MSR.TRAIN_WORDS);
