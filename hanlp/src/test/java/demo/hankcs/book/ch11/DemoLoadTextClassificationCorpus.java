...
import demo.hankcs.hanlp.classification.corpus.AbstractDataSet;
import demo.hankcs.hanlp.classification.corpus.Document;
...
public class DemoLoadTextClassificationCorpus
{
    public static void main(String[] args) throws IOException
    {
        ...
        dataSet.load(DemoTextClassification.CORPUS_FOLDER); // ②加载data/test/搜狗文本分类语料库迷你版
